...
import { downloadCollectiveExport,downloadRegisteredExport, downloadRegisteredExportNsa, downloadOverviewPdf } from "@/services/exportService.js";
...
<template>
  <div>
    ...
    <div v-else>
      ...
      <div>
        <button @click="downloadOverviewPdf">Download Overview PDF</button>
      </div>
    </div>
    <br>
  </div>
